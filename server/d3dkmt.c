...
struct d3dkmt_object
{
    ...
    char               *runtime;        /* client runtime data */
    mem_size_t          runtime_size;   /* size of client runtime data */
};
...
static struct d3dkmt_object *d3dkmt_object_create( enum d3dkmt_type type, mem_size_t runtime_size, const void *runtime )
{
