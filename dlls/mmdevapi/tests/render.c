...
static const unsigned int sampling_rates[] = { 8000, 11025, 12000, 16000, 22050, 32000, 44100, 48000, 96000, 192000 };
static const unsigned int channel_counts[] = { 1, 2, 4, 6, 8 };
